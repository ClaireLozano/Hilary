...
var _ensureSchema = function(callback) {
    ...
    Cassandra.createColumnFamilies({
        ...
        // ShareCode
        'ShareCodeByGoupId': 'CREATE TABLE "ShareCodeByGoupId" ("groupId" text PRIMARY KEY, "code" text, "role" text)',

        // ShareCode
        'ShareCode': 'CREATE TABLE "ShareCode" ("code" text PRIMARY KEY, "groupId" text, "role" text)'
    }, function(err) {
        if (err) {
            return callback(err);
        }
